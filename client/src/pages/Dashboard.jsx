        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {groups.length === 0 && (
            <div className="col-span-full glass rounded-2xl p-12 text-center animate-fadeIn">
              ...
              <Link to="/" className="inline-flex items-center gap-2 bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-xl shadow-md hover:shadow-lg transition">
