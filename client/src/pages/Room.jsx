        ...
        <div className="mt-4 sm:mt-6 grid grid-cols-1 lg:grid-cols-[280px_1fr] xl:grid-cols-[320px_1fr] gap-4 sm:gap-6">
          {activeTab === 'notes' ? (
            <>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex-1">
                        <span className={`font-semibold ${activeId === n._id ? 'text-white' : 'text-slate-800'}`}>
                          {n.title || 'Untitled'}
                        </span>
                        {n.createdBy && (
                          <span className={`text-xs ml-2 ${activeId === n._id ? 'text-white/80' : 'text-slate-500'}`}>
                            by {n.createdBy.name}
                          </span>
                        )}
                      </div>
                    ...
                    <span className={`text-xs flex items-center gap-1 ${activeId === n._id ? 'text-white/70' : 'text-slate-500'}`}>
              ...
              <section className="glass rounded-2xl p-6 h-[65vh] flex flex-col animate-fadeIn" style={{ animationDelay: '300ms' }}>
                {!activeNote ? (
                  <div className="h-full grid place-items-center">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-semibold text-slate-800 mb-2">No Note Selected</h3>
                      <p className="text-slate-600">Select a note from the sidebar or create a new one</p>
                    </div>
                  </div>
                ) : (
                  <div className="flex-1 flex flex-col">
                    <input
                      ...
                      className="px-4 py-3 bg-white/50 border border-slate-300 rounded-xl text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                    />
                    <textarea
                      ...
                      className="mt-4 flex-1 resize-none px-4 py-3 bg-white/50 border border-slate-300 rounded-xl font-mono text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                    />
